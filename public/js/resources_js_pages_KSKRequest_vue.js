...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    EditDialog: function EditDialog(val) {
      ...
      console.log(val, 'EditDialog', this.transferData, this.indexNo);
    }
  },
  computed: {
    modifiedData: function modifiedData() {
      return this.transferData.map(function (data) {
  ...
  methods: {
    SaveUpates: function SaveUpates() {
      axios.post("".concat(this.baseURL, "SaveEditedUpdates"), this.transferData).then(function (res) {
        console.log(res.data, 'saveupdate');
      });
    },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    modifiedData: function modifiedData() {
      ...
      if (Object.keys(this.ObjectData).length != 0) {
        return this.arrKSKEmployee.filter(function (rec) {
          console.log(_this2.ObjectData.search, 'search mo lang');
          _this2.page = 1;
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios.get("".concat(_this3.baseURL, "KSKEmployees")).then(function (res) {
                  _this3.arrKSKEmployee = res.data;
    ...
    UpdateEmployee: function UpdateEmployee(item) {
      ...
      axios.post("".concat(this.baseURL, "UpdateKSKEmployee"), item).then(function (res) {
        console.log(res.data, 'dsadsdsadsd');
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _EditDialog_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../EditDialog.vue */ "./resources/js/components/EditDialog.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    EditDialog: _EditDialog_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  props: ['ObjectData', 'isLoading'],
  data: function data() {
    return {
  ...
  computed: {
    ...
    modifiedData: function modifiedData() {
      ...
      console.log(this.ObjectData, 'ObjectData.search');

      if (Object.keys(this.ObjectData).length != 0) {
        return this.arrKSKSystems.filter(function (rec) {
          console.log(_this2.ObjectData.search, 'ObjectData.search mo lang');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    UpdateDialog: function UpdateDialog(val) {
      console.log(val, '99999999999999');

      if (val) {
        this.indexNo = 1;
        this.clearAll = false;
        console.log(val, 'UpdateDialog');
      }
    }
  },
  methods: {
    ...
    modifiedData: function modifiedData() {
      ...
      if (Object.keys(this.ObjectData).length != 0) {
        return this.arrRequester.filter(function (rec) {
          console.log(_this.ObjectData.search, 'ObjectData.search mo lang');
          _this.page = 1;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return axios.get("".concat(_this3.baseURL, "RequesterEmails")).then(function (res) {
                  console.log(res.data, 'fetchRequesterEmails');
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return axios.get("".concat(_this4.baseURL, "SentEmails")).then(function (res) {
                  console.log(res.data, 'fetchSentEmails');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    modifiedData: function modifiedData() {
      ...
      if (this.arrTask.length > 0) {
        ...
        return this.arrTask.map(function (data) {
          ...
          //   newData.KindName = this.Kinds[kind].KindName
          // }


          console.log(newData, 'modifued');
          return newData;
        })[0];
      } else {
        console.log('modifiedData else');
  ...
  methods: {
    SwitchMode: function SwitchMode(e) {
      ...
      this.ObjData = Object.assign({}, '');
      this.Code = null;
      console.log(this.radio, 'SwitchMode');
    },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return axios.post("".concat(_this2.baseURL, "getReferenceData"), Obj).then(function (res) {
                  _this2.arrTask = res.data.map(function (data) {
                    var newData = Object.assign({}, data);
                    newData.inEditMode = false;
                    newData.Action = 'view';
                    return newData;
                  });
                  _this2.Objtemp.stat = res.data[0].StatusCode;
                  _this2.Objtemp.Fdate = res.data[0].FinishedDate;
                  console.log(_this2.arrTask, 'testesrtstestses', res.data);
                });
    ...
    finishDate: function finishDate(e) {
      if (e.target.checked) {
        console.log('if checked =', e.target.checked);
        this.arrTask[0].FinishedDate = this.moment().format('YYYY/MM/DD');
        this.arrTask[0].StatusCode = '3';
      } else {
        console.log('else checked =', e.target.checked);
        this.arrTask[0].FinishedDate = this.Objtemp.Fdate;
        this.arrTask[0].StatusCode = this.Objtemp.stat;
      }

      console.log(this.arrTask[0].FinishedDate, 'finishdate', this.arrTask[0].StatusCode);
    },
    SaveUpdate: function SaveUpdate() {
      var _this3 = this;

      axios.post("".concat(this.baseURL, "SaveUpdateTask"), this.modifiedData).then(function () {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return axios.get("".concat(_this4.baseURL, "UnfinishTask")).then(function (res) {
                  ...
                  console.log(res.data, 'dajskdbbdsa');
                });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({
    moment: (moment__WEBPACK_IMPORTED_MODULE_1___default())
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)(['getUser'])), {}, {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                console.log(_this4.UserInfo, 'dsadsadsasad');
                ...
                } // this.sections[this.sections.findIndex(arr=>arr.CompanyCode === '003' 
                //                                     && arr.SectionCode === this.UserInfo[0].SectionCode )].SectionName
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return axios.get("".concat(_this6.baseURL, "SystemForRequest")).then(function (response) {
                  _this6.arrSystem = response.data;
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return axios.get("".concat(_this7.baseURL, "Requestor")).then(function (response) {
                  _this7.arrRequestor = response.data;
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return axios.get("".concat(_this8.baseURL, "fetchCC")).then(function (response) {
                  _this8.formContent.CC = response.data.map(function (rec) {
                    return rec.EmployeeName;
                  }).join(', ');
                  _this8.formContent.CCEmail = response.data.map(function (rec) {
                    return rec.Email;
                  }).toString();
                });
    ...
    onChangeSubject: function onChangeSubject() {
      ...
      console.log(System, kindType, 'dsasadsad');
      ...
      if (this.formContent.SystemName.length != 0) {
        if (System > -1) {
          ...
          console.log(this.SystemMaster[System], 'if', app);
        } else {
          console.log('else', this.Approver[0].ID);
    ...
    arrAttachments: function arrAttachments(val) {
      console.log(val, 'arrAttachments');
      this.formContent.Attachments = val;
      var a = val.map(function (data) {
        return data.name;
      });
      console.log(a, 'brasksks');
      this.formContent.Attach = a.join(', ');
      console.log(this.formContent.Attach, 'brasksks');
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return axios.get("".concat(_this12.baseURL, "TempReference")).then(function (res) {
                  _this12.formContent.TemporaryNo = res.data;
                  console.log(res.data, 'TempReference');
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                // this.isLoading = true 
                console.log(_this13.formContent, 'form');
              ...
              case 4:
                _context8.next = 6;
                return axios.post("".concat(_this13.baseURL, "ForApprovalEmailSending"), _this13.formContent).then(function (result) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 3:
                ...
                console.log(_this14.attemp, 'sending');
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _context10.next = 2;
                return axios.post("".concat(_this15.baseURL, "SaveRequestDetails"), _this15.formContent).then(function (result) {
                  console.log(result.data, 'SaveRequestDetails');
                  ...
                  console.log(err.message, 'SaveRequestDetails');
                });

              case 2:
                console.log(_this15.formContent, 'SaveRequestForApproval');
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _context11.next = 2;
                return axios.post("".concat(_this16.baseURL, "ErrorSaving"), _this16.formContent).then(function (result) {
                  console.log(result.data, 'ErrorSavingButSent');
                })["catch"](function (err) {
                  console.log(err, 'ErrorSavingButSent');
                });
    ...
    FileSaving: function FileSaving() {
      ...
      console.log(this.formContent.Attachments[0].originFileObj, 'originFileObj');
      this.formContent.Attachments.forEach(function (data) {
        var obj = new FormData();
        obj.append('file', data.originFileObj);
        obj.append('filename', data.name);
        obj.append('folderName', _this17.formContent.TemporaryNo);
        console.log(data, 'dadsadsadsadsadsadsa');
        axios.post("".concat(_this17.baseURL, "SaveAttachmentToFileServer"), obj).then(function (result) {
          console.log(result.data, 'SaveAttachments');
        })["catch"](function (err) {
          console.log(err);
        });
      });
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\ninput[data-v-d1dae8c6]{\n    margin: 0%;\n    padding: 0%;\n    font-size:12px !important; \n    height: 25px !important; \n    width:100% !important;\n}\n.selectformat[data-v-d1dae8c6]{ \n    margin: 0%;\n    padding: 0%;\n    font-size:12px !important; \n    height: 25px !important; \n    width:100% !important;\n}\nspan[data-v-d1dae8c6]{ \n    font-size: 12px;\n    font-weight: bold;\n    margin-left: 2px !important;\n    margin: 0%;\n    padding: 0%;\n}\n.ButtonFormat[data-v-d1dae8c6]{\n    margin: 5px; \n    margin-bottom: 0% !important;\n    color:white;\n    background-color:  #1ca9fa;\n}\n.ButtonFormat[data-v-d1dae8c6]:hover{\n    background-color:  #06669e;\n}\n.cardformat[data-v-d1dae8c6]{\n    padding: 0% !important;\n}\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditDialog_vue_vue_type_style_index_0_id_d1dae8c6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditDialog_vue_vue_type_style_index_0_id_d1dae8c6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _EditDialog_vue_vue_type_template_id_d1dae8c6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EditDialog.vue?vue&type=template&id=d1dae8c6&scoped=true& */ "./resources/js/components/EditDialog.vue?vue&type=template&id=d1dae8c6&scoped=true&");
...
/* harmony import */ var _EditDialog_vue_vue_type_style_index_0_id_d1dae8c6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css& */ "./resources/js/components/EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _EditDialog_vue_vue_type_template_id_d1dae8c6_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _EditDialog_vue_vue_type_template_id_d1dae8c6_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "d1dae8c6",
  null
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EditDialog_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditDialog.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EditDialog_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/components/EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css&":
/*!*********************************************************************************************************!*\
  !*** ./resources/js/components/EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css& ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_EditDialog_vue_vue_type_style_index_0_id_d1dae8c6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=style&index=0&id=d1dae8c6&scoped=true&lang=css&");
...
/***/ "./resources/js/components/EditDialog.vue?vue&type=template&id=d1dae8c6&scoped=true&":
/*!*******************************************************************************************!*\
  !*** ./resources/js/components/EditDialog.vue?vue&type=template&id=d1dae8c6&scoped=true& ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditDialog_vue_vue_type_template_id_d1dae8c6_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditDialog_vue_vue_type_template_id_d1dae8c6_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditDialog_vue_vue_type_template_id_d1dae8c6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditDialog.vue?vue&type=template&id=d1dae8c6&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=template&id=d1dae8c6&scoped=true&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=template&id=d1dae8c6&scoped=true&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/EditDialog.vue?vue&type=template&id=d1dae8c6&scoped=true& ***!
  \**********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
              ...
              _vm.index === "1"
                ? _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("a-input", {
                        attrs: { placeholder: "System Name" },
                        model: {
                          value: _vm.transferData.SystemName,
                          callback: function ($$v) {
                            _vm.$set(_vm.transferData, "SystemName", $$v)
                          },
                          expression: "transferData.SystemName",
                        },
                      }),
                      _vm._v(" "),
                      _c("span", [_vm._v("is comp")]),
                      _vm._v(" "),
                      _c(
                        "a-select",
                        {
                          staticClass: "selectformat",
                          attrs: {
                            showArrow: "",
                            size: "small",
                          ...
                          model: {
                            value: _vm.transferData.iscomp,
                            callback: function ($$v) {
                              _vm.$set(_vm.transferData, "iscomp", $$v)
                            },
                            expression: "transferData.iscomp",
                          },
                        },
                        _vm._l(_vm.categories, function (item, i) {
                          return _c(
                            "a-select-option",
                            { key: i, attrs: { value: item.iscomp } },
                            [
                              _vm._v(
                                "\n                        " +
                                  _vm._s(item.iscompName) +
                                  "\n                    "
                              ),
                            ]
                          )
                      ...
                      _c(
                        "a-select",
                        {
                          ...
                          model: {
                            value: _vm.transferData.ApproverID,
                            callback: function ($$v) {
                              _vm.$set(_vm.transferData, "ApproverID", $$v)
                            },
                            expression: "transferData.ApproverID",
                          },
                        },
                ...
                : _c(
                    "div",
                    [
                      _c("span", [_vm._v("Requester Name")]),
                      _vm._v(" "),
                      _c("a-input", {
                        attrs: { placeholder: "Requester Name" },
                        model: {
                          value: _vm.transferData.Requester,
                          callback: function ($$v) {
                            _vm.$set(_vm.transferData, "Requester", $$v)
                          },
                          expression: "transferData.Requester",
                        },
                      }),
                      _vm._v(" "),
                      ...
                      _c("a-input", {
                        ...
                        model: {
                          value: _vm.transferData.Email,
                          callback: function ($$v) {
                            _vm.$set(_vm.transferData, "Email", $$v)
                          },
                          expression: "transferData.Email",
                        },
                      }),
                    ],
                    1
